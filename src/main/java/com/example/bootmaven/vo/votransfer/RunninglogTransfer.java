...
public interface RunninglogTransfer {
     ...
     * @param list
     */
    List<Runninglog> vList2dList(List
                                         <RunninglogVO> list);
     ...
     */
    List
            <RunninglogVO> dList2vList(List<Runninglog> list);
     ...
     */
    IPage
            <RunninglogVO> dPage2vPage(IPage<Runninglog> page);
     ...
     * @param list
     */
    IPage<Runninglog> vPage2dPage(IPage
                                          <RunninglogVO> page);
