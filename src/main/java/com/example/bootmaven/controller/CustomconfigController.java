...
*/
 ...
 public R<IPage<Customconfig>> page(IPage<Customconfig> page, Customconfig  entity)
 {
 try{
 ...
 */
 ...
 public R<List<Customconfig>> listAll(Customconfig  entity)
 {
 try{
 return success(this.iCustomconfigService.list(new QueryWrapper<Customconfig>(entity)));
 } catch (Exception ex) {
 return failed(ex.getMessage());
 }
 }
...
public R<Boolean> save(@RequestBody Customconfig  entity)
 {
 try{
return success(this.iCustomconfigService.save(entity));
 } catch (Exception ex) {
 return failed(ex.getMessage());
 }
}
...
public R<Boolean> update(@RequestBody Customconfig  entity) {
 try{
return success(this.iCustomconfigService.updateById(entity));
 } catch (Exception ex) {
 return failed(ex.getMessage());
 }
}
