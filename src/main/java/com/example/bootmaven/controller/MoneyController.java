...
public R
<Page<Money>> page(Page<Money> page, Money  entity)
{
try{
...
public R
<List<Money>> listAll(Money  entity)
{
try{
...
public R
<Boolean> save(@RequestBody Money entity)
    {
    try{
    ...
    */
    ...
    public R
    <Boolean> update(@RequestBody Money entity) {
        try{
