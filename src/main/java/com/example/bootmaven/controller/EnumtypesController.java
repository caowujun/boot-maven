...
*/
 ...
 public R<IPage<Enumtypes>> page(IPage<Enumtypes> page, Enumtypes  entity)
 {
 try{
 ...
 */
 ...
 public R<List<Enumtypes>> listAll(Enumtypes  entity)
 {
 try{
...
public R<Boolean> save(@RequestBody Enumtypes  entity)
 {
 try{
...
public R<Boolean> update(@RequestBody Enumtypes  entity) {
 try{
